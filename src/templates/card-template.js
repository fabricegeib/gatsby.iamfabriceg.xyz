                        ...
                        <div className="hero-container">
                            ...
                            <div className="hero-informations">
                                ...
                                <div className="hero-informations__block">
                                    ...
                                    <div className="hero-informations__subblock">
                                        {props.data.heroesJson.classPerks && <div data-class={props.data.heroesJson.classPerks[0].title}></div>}

                                        <div>
                                            {props.data.heroesJson.classPerks && <h4>{props.data.heroesJson.classPerks[0].title}</h4>}
                                            {props.data.heroesJson.classPerks && <p>{props.data.heroesJson.classPerks[0].text}</p>}
                                        </div>
                                    </div>

                                    <div className="hero-informations__subblock">
                                        {props.data.heroesJson.classPerks && <div data-class={props.data.heroesJson.classPerks[1].title}></div>}
                                        <div>
                                            {props.data.heroesJson.classPerks && <h4>{props.data.heroesJson.classPerks[1].title}</h4>}
                                            {props.data.heroesJson.classPerks && <p>{props.data.heroesJson.classPerks[1].text}</p>}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="hero-informations__block">
                                    ...
                                    <div className="hero-informations__subblock">
                                        {props.data.heroesJson.abilities && <div data-ability={props.data.heroesJson.abilities[0].title}></div>}

                                        <div>
                                            {props.data.heroesJson.abilities && <h4>{props.data.heroesJson.abilities[0].title}</h4>}
                                            {props.data.heroesJson.abilities && <p>{props.data.heroesJson.abilities[0].text}</p>}
                                            {props.data.heroesJson.abilities && <p>{props.data.heroesJson.abilities[0].cost} energy</p>}
                                            {props.data.heroesJson.abilities && <p>{props.data.heroesJson.abilities[0].cooldown} seconds</p>}
                                        </div>
                                    </div>

                                    <div className="hero-informations__subblock">
                                        {props.data.heroesJson.abilities && <div data-ability={props.data.heroesJson.abilities[1].title}></div>}

                                        <div>
                                            {props.data.heroesJson.abilities && <h4>{props.data.heroesJson.abilities[1].title}</h4>}
                                            {props.data.heroesJson.abilities && <p>{props.data.heroesJson.abilities[1].text}</p>}
                                            {props.data.heroesJson.abilities && <p>{props.data.heroesJson.abilities[1].cost} energy</p>}
                                            {props.data.heroesJson.abilities && <p>{props.data.heroesJson.abilities[1].cooldown} seconds</p>}
                                        </div>
                                    </div>

                                    <div className="hero-informations__subblock">
                                        {props.data.heroesJson.abilities && <div data-ability={props.data.heroesJson.abilities[2].title}></div>}

                                        <div>
                                            {props.data.heroesJson.abilities && <h4>{props.data.heroesJson.abilities[2].title}</h4>}
                                            {props.data.heroesJson.abilities && <p>{props.data.heroesJson.abilities[2].text}</p>}
                                            {props.data.heroesJson.abilities && <p>{props.data.heroesJson.abilities[2].cost} energy</p>}
                                            {props.data.heroesJson.abilities && <p>{props.data.heroesJson.abilities[2].cooldown} seconds</p>}
                                        </div>
                                    </div>
                                </div>
